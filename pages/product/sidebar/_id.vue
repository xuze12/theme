                  ...
                  <div class="col-lg-6">
                    <div v-swiper:mySwiper="swiperOption" ref="mySwiper">
                      <div class="swiper-wrapper">
                        <div
                          class="swiper-slide"
                          v-for="(item, index) in (prodInfo.imgs || '').split(',')"
                          :key="index"
                        >
                          <img
                            :src="'http://img-test.gz-yami.com/' + item"
                            :id="prodInfo.shopId"
                  ...
                  <div class="col-lg-6 rtl-text">
                    <div class="product-right">
                      ...
                      <div class="product-description border-product">
                        ...
                        <div class="size-box">
                          <ul
                            style="width: 100%;display: inline-flex;flex-wrap: wrap; height: 10vw;overflow: auto;"
                          >
                            <li
                              class="product-title"
                              style="width:230px;height:40px;border-radius:10px;margin:10px 0"
                              v-bind:class="{ active: skuId == size.skuId }"
                              v-for="(size, index) in prodInfo.skuList"
                              :key="index"
                            >
                              <a
                                href="javascript:void(0)"
                                @click="changeSkuId(size)"
