  ...
  <div>
        ...
        <div class="setting-body">
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>tools</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/tools' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>pets</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/pets' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>jewellery</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/jewellery' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Fashion</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/fashion-2' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Fashion</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/fashion-3' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Shoes</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/shoes' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Bags</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/bags' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Watch</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/watch' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Kids</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/kids' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Flower</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/flower' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Vegetables</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/vegetables' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Beauty</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/beauty' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Electronic</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/electronics-1' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects mb-0">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Furniture</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/furniture' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>left sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/leftsidebar/all' }" class="btn new-tab-btn" target="_blank">
                        Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>right sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/right-sidebar' }" class="btn new-tab-btn" target="_blank">
                        Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>no sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/no-sidebar' }" class="btn new-tab-btn" target="_blank">
                        Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>popup</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/sidebar-popup' }" class="btn new-tab-btn" target="_blank">
                        Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>metro</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/metro' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>full width</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/full-width' }" class="btn new-tab-btn" target="_blank">
                        Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>three grid</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/three-grid' }" class="btn new-tab-btn" target="_blank">
                        Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects mb-0">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>six grid</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/six-grid' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects mb-0">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>list view</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/list-view' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>four image</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/four-image' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>left sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/sidebar/1' }" class="btn new-tab-btn" target="_blank">Preview
                      </nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>no sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/sidebar/no-sidebar' }" class="btn new-tab-btn" target="_blank">
                        Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>bundle</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/bundle-product' }" class="btn new-tab-btn" target="_blank">
                        Preview</nuxt-link>
                    </div>
                  </div>
                </div>
          ...
          <div class="setting-contant" :class="{ opensubmenu: isActive('color option') }">
            <ul class="color-box">
              ...
              <li>
                <a href="javascript:void(0)" class="color10" @click="customizeThemeColor('color10')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color11" @click="customizeThemeColor('color11')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color12" @click="customizeThemeColor('color12')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color13" @click="customizeThemeColor('color13')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color14" @click="customizeThemeColor('color14')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color15" @click="customizeThemeColor('color15')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color16" @click="customizeThemeColor('color16')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color17" @click="customizeThemeColor('color17')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color18" @click="customizeThemeColor('color18')"></a>
              </li>
            </ul>
          </div>
          ...
          <div class="setting-contant" :class="{ opensubmenu: isActive('rtl') }">
            <ul class="setting_buttons">
              <li class="active" id="ltr_btn">
                <a href="javascript:void(0)" @click="customizeLayoutType('')" class="btn setting_btn">LTR</a>
              </li>
              <li id="rtl_btn">
    ...
    <div class="addcart_btm_popup" id="fixed_cart_icon">
      <a href="#" class="fixed_cart">
        <i class="fa fa-clone" aria-hidden="true" v-b-tooltip.hover title="Configuration"
