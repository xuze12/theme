        ...
        <div class="collection-collapse-block" :class="{ open: openBlock }">
          ...
          <div class="collection-collapse-block-content">
            <div class="collection-brand-filter">
              <ul class="category-list" v-if="!isLink">
                <li v-for="(item,index) in categoryList" :key="index" @click="getPageProdsList(item.categoryId)">
                  <span :style="{color:'#777777',cursor:'pointer'}">{{item.categoryName}}</span>
                </li>
              </ul>
              <ul class="category-list" v-if="isLink">
                <li v-for="(item,index) in categoryList" :key="index">
                  <nuxt-link :to="{ path: `/collection/leftsidebar/${item.categoryId}`}"
                    :style="{color:'#777777',cursor:'pointer'}">{{item.categoryName}}</nuxt-link>
                </li>
              </ul>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions(["getLastedProdPage", "getCategoryList", "getPageProdsList"]),
