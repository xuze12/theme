      ...
      <div class="row quickview-modal">
        ...
        <del>{{ productData.price * curr.curr | currency(curr.symbol) }}</del>
            ...
            <div class="product-buttons">
              <a href="javascript:void(0)" @click="addToCart(product)" class="btn btn-solid">加入购物车</a>
              <nuxt-link :to="{ path: '/product/sidebar/'+productData.id}" class="btn btn-solid">查看详细信息</nuxt-link>
            </div>
          </div>
        </div>
      </div>
